...
allowed_hosts_env = os.environ.get('ALLOWED_HOSTS', 'localhost,127.0.0.1,192.168.0.7,192.168.0.3,192.168.0.16,192.168.0.9') #colocar la ip de su red cuando trabaje con celular
